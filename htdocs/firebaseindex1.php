...
if(isset($_GET['logout'])){    
    ...
    session_destroy();
    header("Location: firebaseindex1.php"); //Redirect the user
}
...
function loginForm(){
    echo
    '<div id="loginform" style="height:300px;width:800px">
    	<div id="loginformalign">
    <p>Please enter your name to join the chat</p>
    <form action="firebaseindex1.php" method="post" autocomplete="off">
    ...
    if(!isset($_SESSION['name'])){
        ...
        <div id="wrapper">
            ...
            <form name="message" action="" autocomplete="off" onkeydown="return event.key!='Enter';">
               ...
               <input type="file" id="file" name="files" style="position:absolute;margin-left:600px">
                <input type="button" onclick="go()" id="send" style="background-image: url('send.png');background-size:100% 100%;width: 50px;height: 50px;
   border: none;" value=""/>
				<progress id="progress" value="0" max="100" style="position:absolute;height:20;margin-left:400px;margin-top:70px ;display:none"></progress>
<br><p id="filename" style="position:absolute;margin-left:400px;margin-top:50px;font-weight:bold;color:green"></p>
            </form>
        </div>
...
if ( window.history.replaceState ) window.history.replaceState( null, null, window.location.href );
 ...
 document.getElementById("chatbox").style.width="800px";
            ...
            $(document).ready(function () {
               ...
               if(document.querySelector("#file").files[0]!=null)
                ...
                $("#exit").click(function () {
                    ...
                    if (exit == true) {
                    window.location = "firebaseindex1.php?logout=true";
                    }
                });
            });
        </script>
